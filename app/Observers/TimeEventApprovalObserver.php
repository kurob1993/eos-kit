...
use App\Notifications\TimeEventApprovalCreatedMessage;

class TimeEventApprovalObserver
{
  public function created(TimeEventApproval $timeEventApproval)
  {
      // to adalah karyawan yang mengajukan
      $to = Employee::findByPersonnel($timeEventApproval->regno)
          ->first()
          ->user;
