...
@component('layouts.personnel_service._page-container', ['page_header' => 'Other Activity'])
    ...
    <div class="panel-body">
        ...
        <div class="row m-b-15">
            ...
            <div class="col-sm-3 m-t-25">
                <form action="{{route('personnel_service.other-activity.export')}}" method="get">
...
@include('all_other_activity.script')
@endpush