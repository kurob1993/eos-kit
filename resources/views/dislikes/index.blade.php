...
@component('layouts.employee._page-container', ['page_header' => 'Dislike'])
<div class="panel panel-prussian">
  <div class="panel-heading">
    <h4 class="panel-title">Daftar jabatan yang tidak saya sukai</h4>
  </div>
  @include('layouts._flash')
  <div class="panel-body">
    <p> <a class="btn btn-primary" href="{{ route('dislike.create') }}">Tambah</a> </p>
