...
@component('layouts.secretary._page-container', ['page_header' => 'Pengajuan Lembur'])
<div class="row">
  <div class="col-lg-12 col-xl-9">
    <div class="panel panel-prussian">
      ...
      <div class="panel-body">
        {!! Form::open([
            'url' => route('secretary.overtimes.store'), 
            'method' => 'post', 
            'class'=>'form-horizontal', 
            'data-parsley-validate' => 'true'
            ])
        !!}
        @include('secretary.overtimes._form')
        {!! Form::close() !!}
      </div>
    </div>
  </div>
...
@push('custom-scripts')
@include('scripts._secretary-overtime-script',[
