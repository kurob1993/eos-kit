...
@component('layouts.employee._page-container', ['page_header' => 'Pengajuan SPD'])
<div class="panel panel-prussian">
  <div class="panel-heading">
    <h4 class="panel-title">Daftar SPD Saya</h4>
  </div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">SPD (ID: <span id="title-span"></span>)</h4>
      </div>
