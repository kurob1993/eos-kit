...
Route::group([
    ...
    // route peralihan aproval
    Route::get('transition/zhrom0007', 'TransitionController@zhrom0007')->name('transition.zhrom0007');
    Route::get('transition/employee', 'TransitionController@employee')->name('transition.employee');
